...
function submitHandler() {
    ...
    var subject = "Katlynn Millions Voiceover Site - User Request Query";
    var emailBody = "Word Count: " + wordCount +
    "%0d%0aSplit Files: " + splitFiles + 
    "%0d%0aHow Soon?: " + days + 
    "%0d%0aMonetized Online?: " + (monOnline ? "Yes" : "No") + 
    "%0d%0aPlayed on terrestrial radio or television?: " + (terrestrial ? "Yes" : "No") + 
    "%0d%0aProof reading required: " + (proofRead ? "Yes" : "No") + 
    "%0d%0aAudio/Visual sync required?: " + (avSync ? "Yes" : "No") + 
    "%0d%0aQuote Amount: $" + quoteAmount;

    $(".quote-information").html("Quote Amount: $" + quoteAmount + " <a>Email this Quote to Katlynn</a>"); 
    $(".quote-information a").attr("href", "mailto:smansfield33@gmail.com?subject=" + subject + "&body=" + emailBody);
}
